...
// ../../../../private/var/folders/qr/91qws8gs1w50j6wlj202tbnc0000gn/T/tmp.LUsAYrNG0t/components/visuals/tokens.ts
var C = {
  ground: "#070809",
  cardShell: "#0D0E10",
  cardBorder: "#1B1E20",
  ...
  sub: "#5C6470",
  line: "#E4E3DF",
  /** On-stage white. Distinct from `ink`, which is for LIGHT surfaces. */
  white: "#FFFFFF",
  dimInk: "rgba(255,255,255,0.42)"
};
var MONO = "'JetBrains Mono',monospace";
var SANS = "'Inter Tight',sans-serif";
var STAGE_W = 1600;
var STAGE_H = 900;
var GROUND_TINT = {
  "manual-time": "#131A18",
  "lead-quantity": "#101418",
  "lead-quality": "#181114",
  "cost-per-result": "#18140F",
  inconsistency: "#0E1418"
};
...
function sweep(t, i, n) {
  return Math.max(0, 1 - Math.abs(t % 1 * (n + 1) - 0.5 - i) * 1.4);
}
